                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table id="datatable1" class="table table-hover table-bordered">
                                                <thead>
                                                    <tr>
                                                        <th>#</th>
                                                        <th>Sales Date<i class="fa fa-sort"></i></th>
                                                        <th>Store Location</th>
                                                        <th>Total Sales (RM)</th>
                                                        <th class="text-wrap">Total Sales in Quantity</th>
                                                        <th>Sales Manager</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ $sales->sales_location }}</td>
                                                        <td>{{ $sales->sales_total }}</td>
                                                        <td>{{ $sales->sales_product_quantity }}</td>
                                                        <td>{{ $sales->sales_manager }}</td>
                                                        {{-- <td></td>
                                                        <td></td>
