<!-- Modal -->
<div class="modal fade" id="StripeCardModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form role="form" action="{{ route('sale#StoreSale') }}" method="POST" data-cc-on-file="false" id="payment-form"
          ...
          <div class="row">
            ...
            <div class="col-md-4 required">
              <div class="form-group">
                ...
                <input type="text" autocomplete="off" class="form-control card-cvc" required placeholder="ex. 311"
                  size="4">
              </div>
            </div>
            <div class="col-md-4">
